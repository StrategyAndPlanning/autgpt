  ...
  return (
    <div className="grid grid-cols-5 w-full items-center container mx-auto max-w-3xl justify-center h-full gap-9">
      <div className="col-span-2 gap-5 flex flex-col flex-1">
        <Typography variant="h4">Kia ora, start chatting.</Typography>
        <p className="" style={{fontSize: 14.5}}>
          This GPT model is exclusively available for AUT’s own use, ensuring privacy and control over our content.
        </p>
        <p className="" style={{fontSize: 14.5}}>
        The responses generated by AUTGPT may contain inaccuracies and should be verified for accuracy and reliability before use. Please note that
information generated by AUTGPT is based on data available up until September 2021 and may not reflect current or updated facts. If you have questions about this tool, please visit: <a href="https://bi.aut.ac.nz" target="_blank" style={{color: "blue"}}>https://bi.aut.ac.nz</a> 
        </p>
      </div>
